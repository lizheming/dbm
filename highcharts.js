...
fontSize:"12px",padding:"5px",whiteSpace:"nowrap"}},credits:{enabled:!0,text:"豆瓣电影统计",href:"http://imnerd.org/lab/douban",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",color:"#909090",fontSize:"13px"}}};var cc={dateTimeLabelFormats:Oa(Ab,"%H:%M:%S.%L",mb,"%H:%M:%S",Bb,"%H:%M",Pa,"%H:%M",na,"%e. %b",Ka,"%e. %b",Xa,"%b '%y",za,"%Y"),endOnTick:!1,gridLineColor:"#C0C0C0",labels:A,lineColor:"#C0D0E0",lineWidth:1,max:null,min:null,minPadding:0.01,maxPadding:0.01,
...
(function(e) {
    ...
    w = e.getOptions();
    o(w.lang, {
        downloadJPEG: "下载成JPEG格式图片",
        downloadPNG: "下载成PNG格式图片",
        downloadPDF: "下载成PDF格式文档",
        downloadSVG: "下载成SVG格式图片",
        exportButtonTitle: "导出成栅格或者矢量图像",
        printButtonTitle: "打印表格"
    });
    w.navigation = {
        menuStyle: {
    ...
    o(z.prototype, {
        getSVG: function(a) {
            ...
            function(a) {
                ...
                function(b, d) {
                    ...
                    g = b.getExtremes(),
                    e = g.userMin,
                    g = g.userMax; (e !== void 0 || g !== void 0) && f.setExtremes(e, g, !0, !1)
                })
            });
        ...
        print: function() {
            ...
            f = i.body,
            g = f.childNodes;
            if (!a.isPrinting) a.isPrinting = !0,
            k(g,
            function(a, b) {
                if (a.nodeType === 1) c[b] = a.style.display,
        ...
        contextMenu: function(a, b, c, d, f, g) {
            ...
            e.exportDivElements.push(x, h),
            e.exportMenuWidth = h.offsetWidth,
            e.exportMenuHeight = h.offsetHeight;
            a = {
                display: "block"
            };
        ...
        destroyExport: function() {
            var a, b;
            for (a = 0; a < this.exportSVGElements.length; a++) b = this.exportSVGElements[a],
            ...
            B(b, "mouseleave"),
            this.exportDivElements[a] = b.onmouseout = b.onmouseover = b.ontouchstart = b.onclick = null,
            v(b)
        }
    });
